...
export default function Education() {
  return (
    <div className="mt-20">
      <div
        className={`${styles.wrapper}  flex flex-wrap justify-center gap-20 `}
      >
        <div className={styles.card}>
          ...
          <div className={`${styles.backpage} bg-[#E9E9E9] dark:bg-[#394150]`}>
            <div className={styles.cardcontent}>
              <h3
                className={`${courierPrime.className} text-center text-black dark:text-white text-[20px]`}
              >
        ...
        <div className={styles.card}>
          ...
          <div className={`${styles.backpage} bg-[#E9E9E9] dark:bg-[#394150]`}>
            <div className={styles.cardcontent}>
              ...
              <div
                className={`${sourceCodePro.className} text-black dark:text-white`}
              >
                <p className={styles.carddescription}>
